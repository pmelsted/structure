...
/*Program options */
int USEPOPINFO, INFERALPHA, INFERLAMBDA,POPSPECIFICLAMBDA,
    PFROMPOPFLAGONLY;
int POPALPHAS, COMPUTEPROB, NOADMIX, ADMBURNIN;
int MAPDISTANCES, MARKERNAMES, LINKAGE, PHASED,PHASEINFO,
    MARKOVPHASE;

/*Output Options */
int UPDATEFREQ, PRINTLIKES, INTERMEDSAVE, PRINTKLD,
    PRINTNET, PRINTLAMBDA;
...
double MIGRPRIOR, ALPHA, FPRIORMEAN,FPRIORSD, LAMBDA,
       MIGRPRIOR;
double ALPHAMAX, ALPHAPRIORA, ALPHAPRIORB;
/*Miscellaneous */
int STARTATPOPINFO;
double ALPHAPROPSD, LOG10RPROPSD,LOG10RMIN,LOG10RMAX,
       LOG10RSTART;
...
int NUMSIMSTATS, NUMPHENS, POOLFREQ, LOCUSxONLY,
    MISSINGPHENO, PHENOTYPECOL;
double EMERROR;
