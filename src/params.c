  ...
  the command line for a few special parameters*/
{
    ...
    InputFileNames(argc,argv,filename,
                   "-m");  /*check for command line change to input file*/
    OpenFile(filename);
    ReadFile();
    fclose(PARAMS);
    ...
    */
    ...
    for (i=0; i<argc-1; i++) {
        if (strcmp(argv[i],"-i")==0) {
            ...
            MAXPOPS = CommandLineInts(value,"MAXPOPS");
        } else if (strcmp(argv[i],"-L")==0) {
            sprintf (value,"%s",argv[i+1]);
            NUMLOCI = CommandLineInts(value,"NUMLOCI");
        } else if (strcmp(argv[i],"-N")==0) {
            sprintf (value,"%s",argv[i+1]);
            NUMINDS = CommandLineInts(value,"NUMINDS");
        } else if (strcmp(argv[i],"-r")==0) {
            sprintf (value,"%s",argv[i+1]);
            NUMSIMSTATS = CommandLineInts(value,"NUMSIMSTATS");
        } else if (strcmp(argv[i],"-c")==0) {
            sprintf (value,"%s",argv[i+1]);
            PHENOTYPECOL = CommandLineInts(value,"PHENOTYPECOL");
...
mainparams, extraparams or STRATparams*/
{
    ...
    if (!(found)) {
        if (strcmp(flag,"-m")==0) {
            sprintf (filename, "%s","mainparams");
        } else if (strcmp(flag,"-e")==0) {
            sprintf (filename, "%s","extraparams");
        } else if (strcmp(flag,"-s")==0) {
            sprintf (filename, "%s","STRATparams");
        }
    }
...
void SetValue(char Word[])
{
    ...
    if (!(strcmp(Word,"INFILE"))) {
        ReadSpaceString(DATAFILE,STRLEN,PARAMS);

        printf("datafile is\n%s\n",DATAFILE);
    } else if (!(strcmp(Word,"OUTFILE"))) {
        ReadSpaceString(OUTFILE,STRLEN,PARAMS);
    } else if (!(strcmp(Word,"NUMINDS"))) {
        ret = fscanf(PARAMS,"%d",&NUMINDS);
    } else if (!(strcmp(Word,"NUMLOCI"))) {
        ret = fscanf(PARAMS,"%d",&NUMLOCI);
    } else if (!(strcmp(Word,"MISSING"))) {
        ret = fscanf(PARAMS,"%d",&MISSING);
    } else if (!(strcmp(Word,"LABEL"))) {
        ret = fscanf(PARAMS,"%d",&LABEL);
    } else if (!(strcmp(Word,"POPDATA"))) {
        ret = fscanf(PARAMS,"%d",&POPDATA);
    } else if (!(strcmp(Word,"MARKERNAMES"))) {
        ret = fscanf(PARAMS,"%d",&MARKERNAMES);
    } else if (!(strcmp(Word,"PHASEINFO"))) {
        ret = fscanf(PARAMS,"%d",&PHASEINFO);
    } else if (!(strcmp(Word,"MAPDISTANCES"))) {
        ret = fscanf(PARAMS,"%d",&MAPDISTANCES);
    } else if (!(strcmp(Word,"MARKOVPHASE"))) {
        ret = fscanf(PARAMS,"%d",&MARKOVPHASE);
    } else if (!(strcmp(Word,"PLOIDY"))) {
        ret = fscanf(PARAMS,"%d",&LINES);
    } else if (!(strcmp(Word,"ONEROWPERIND"))) {
        ret = fscanf(PARAMS,"%d",&ONEROWPERIND);
    } else if (!(strcmp(Word,"RECESSIVEALLELES"))) {
        ret = fscanf(PARAMS,"%d",&RECESSIVEALLELES);
    } else if (!(strcmp(Word,"NOTAMBIGUOUS"))) {
        ret = fscanf(PARAMS,"%d",&NOTAMBIGUOUS);
    } else if (!(strcmp(Word,"POPFLAG"))) {
        ret = fscanf(PARAMS,"%d",&POPFLAG);
    } else if (!(strcmp(Word,"PHENOTYPE"))) {
        ret = fscanf(PARAMS,"%d",&PHENOTYPE);
    } else if (!(strcmp(Word,"EXTRACOLS"))) {
        ret = fscanf(PARAMS,"%d",&EXTRACOLS);
    } else if (!(strcmp(Word,"MAXPOPS"))) {
        ret = fscanf(PARAMS,"%d",&MAXPOPS);
    } else if (!(strcmp(Word,"BURNIN"))) {
        ret = fscanf(PARAMS,"%d",&BURNIN);
    } else if (!(strcmp(Word,"NUMREPS"))) {
        ret = fscanf(PARAMS,"%d",&NUMREPS);
    } else if (!(strcmp(Word,"USEPOPINFO"))) {
        ret = fscanf(PARAMS,"%d",&USEPOPINFO);
    } else if (!(strcmp(Word,"PFROMPOPFLAGONLY"))) {
        ret = fscanf(PARAMS,"%d",&PFROMPOPFLAGONLY);
    } else if (!(strcmp(Word,"INFERALPHA"))) {
        ret = fscanf(PARAMS,"%d",&INFERALPHA);
    } else if (!(strcmp(Word,"INFERLAMBDA"))) {
        ret = fscanf(PARAMS,"%d",&INFERLAMBDA);
    } else if (!(strcmp(Word,"POPSPECIFICLAMBDA"))) {
        ret = fscanf(PARAMS,"%d",&POPSPECIFICLAMBDA);
    } else if (!(strcmp(Word,"POPALPHAS"))) {
        ret = fscanf(PARAMS,"%d",&POPALPHAS);
    } else if (!(strcmp(Word,"COMPUTEPROB"))) {
        ret = fscanf(PARAMS,"%d",&COMPUTEPROB);
    } else if (!(strcmp(Word,"NOADMIX"))) {
        ret = fscanf(PARAMS,"%d",&NOADMIX);
    } else if (!(strcmp(Word,"ADMBURNIN"))) {
        ret = fscanf(PARAMS,"%d",&ADMBURNIN);
    } else if (!(strcmp(Word,"PHASED"))) {
        ret = fscanf(PARAMS,"%d",&PHASED);
    } else if (!(strcmp(Word,"PRINTQHAT"))) {
        ret = fscanf(PARAMS,"%d",&PRINTQHAT);
    } else if (!(strcmp(Word,"PRINTQSUM"))) {
        ret = fscanf(PARAMS,"%d",&PRINTQSUM);
    } else if (!(strcmp(Word,"UPDATEFREQ"))) {
        ret = fscanf(PARAMS,"%d",&UPDATEFREQ);
    } else if (!(strcmp(Word,"PRINTLIKES"))) {
        ret = fscanf(PARAMS,"%d",&PRINTLIKES);
    } else if (!(strcmp(Word,"INTERMEDSAVE"))) {
        ret = fscanf(PARAMS,"%d",&INTERMEDSAVE);
    } else if (!(strcmp(Word,"PRINTKLD"))) {
        ret = fscanf(PARAMS,"%d",&PRINTKLD);
    } else if (!(strcmp(Word,"PRINTNET"))) {
        ret = fscanf(PARAMS,"%d",&PRINTNET);
    } else if (!(strcmp(Word,"PRINTLAMBDA"))) {
        ret = fscanf(PARAMS,"%d",&PRINTLAMBDA);
    } else if (!(strcmp(Word,"ECHODATA"))) {
        ret = fscanf(PARAMS,"%d",&ECHODATA);
    } else if (!(strcmp(Word,"ANCESTDIST"))) {
        ret = fscanf(PARAMS,"%d",&ANCESTDIST);
        ...
        ret = fscanf(PARAMS,"%d",&RANDOMIZE);
    } else if (!(strcmp(Word,"LINKAGE"))) {
        ret = fscanf(PARAMS,"%d",&LINKAGE);
    } else if (!(strcmp(Word,"METROFREQ"))) {
        ret = fscanf(PARAMS,"%d",&METROFREQ);
    } else if (!(strcmp(Word,"REPORTHITRATE"))) {
        ret = fscanf(PARAMS,"%d",&REPORTHITRATE);
    }

    /* HIDDEN PARAMETERS */
    else if (!(strcmp(Word,"NOQS"))) {
        ret = fscanf(PARAMS,"%d",&NOQS);
    } else if (!(strcmp(Word,"POSTERIOR"))) {
        ret = fscanf(PARAMS,"%d",&POSTERIOR);
    } else if (!(strcmp(Word,"PICTUREFILE"))) {
        ret = fscanf(PARAMS,"%d",&PICTUREFILE);
    } else if (!(strcmp(Word,"INDIVIDUALR"))) {
        ret = fscanf(PARAMS,"%d",&INDIVIDUALR);
    }
    ...
    /* else if (!(strcmp(Word,"NUMPHENS"))) ret = fscanf(PARAMS,"%d",&NUMPHENS);*/
        ...
        ret = fscanf(PARAMS,"%d",&POOLFREQ);
    } else if (!(strcmp(Word,"LOCUSxONLY"))) {
        ret = fscanf(PARAMS,"%d",&LOCUSxONLY);
    } else if (!(strcmp(Word,"PHENOTYPECOL"))) {
        ret = fscanf(PARAMS,"%d",&PHENOTYPECOL);
    } else if (!(strcmp(Word,"MISSINGPHENO"))) {
        ret = fscanf(PARAMS,"%d",&MISSINGPHENO);
    }

    /*Melissa added 7/12/07 to input popprior parameters*/
    else if (strcmp(Word, "LOCPRIOR")==0) {
        ret = fscanf(PARAMS, "%i", &LOCPRIOR);
...
(Obviously this depends on machine speed, but this is probably about right)*/
{
    ...
    if (UPDATEFREQ > 0) {
        return UPDATEFREQ;    /*ie retain user-specified value*/
    }

    else if (approxfreq <= 15) {
        return 10;
    } else if (approxfreq <= 37) {
        return 25;
    } else if (approxfreq <= 75) {
        return 50;
    } else if (approxfreq <= 250) {
        return 100*((int)(approxfreq + 50)/100);
    }
    /*intervals of 100*/
    else {
